...
namespace Application.Service.Implimentations.Services
{
    public class CommentService : ICommentService
    {
        ...
        public CommentService(ICommentRepository commentRepository, MappingProfile mappingProfile, IUserRepository userRepository)
        {
        ...
        public async Task<List<CommentForGettingDtoMain>> GetAllCommentsOfUserAsync(string userId)
        {
            ...
            if (raw.Count == 0)
            {
                throw new ArgumentNullException("Comments not found");
            }
